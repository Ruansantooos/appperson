...
const MobileNav: React.FC = () => {
  ...
  return (
    <div className="lg:hidden fixed bottom-6 left-1/2 -translate-x-1/2 w-[90%] h-16 bg-[#161616]/90 backdrop-blur-xl border border-white/5 rounded-[24px] flex items-center justify-around px-2 z-50 shadow-2xl">
      {navItems.map((item) => {
        ...
        return (
          <Link
            ...
            className={`flex flex-col items-center justify-center gap-1 w-full h-full transition-all ${
              isActive ? 'text-[#c1ff72]' : 'text-white/20'
            }`}
          >
